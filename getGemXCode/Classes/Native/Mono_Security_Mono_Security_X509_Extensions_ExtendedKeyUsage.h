...
struct  ExtendedKeyUsageExtension_t1204  : public X509Extension_t1198
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t110 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1204_StaticFields{
	...
	Dictionary_2_t53 * ___U3CU3Ef__switchU24map14_4;
};
