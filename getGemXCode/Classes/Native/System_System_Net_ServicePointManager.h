...
struct  ServicePointManager_t1311  : public Object_t
{
};
struct ServicePointManager_t1311_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1339 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1323 * ___server_cert_cb_9;
};
