...
struct  X509EnhancedKeyUsageExtension_t1402  : public X509Extension_t1388
{
	...
	OidCollection_t1399 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t1402_StaticFields{
	...
	Dictionary_2_t53 * ___U3CU3Ef__switchU24mapE_6;
};
