...
struct  X509Store_t1396  : public Object_t
{
	...
	X509Certificate2Collection_t1390 * ___list_2;
	...
	X509Store_t1199 * ___store_4;
};
struct X509Store_t1396_StaticFields{
	...
	Dictionary_2_t53 * ___U3CU3Ef__switchU24mapF_5;
};
